...
import com.visitJapan.dao.community.UpdateCommunityDAO;
...
public class CommunityController extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        RequestDispatcher dispatcher = request.getRequestDispatcher("pages/community/share.jsp");
        dispatcher.forward(request, response);
        
	}
	
	protected void doPut(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		UpdateCommunityDAO updateCommunityDAO = new UpdateCommunityDAO();
	    ...
	    boolean result = updateCommunityDAO.putData(id, title, content); // 게시글 수정
